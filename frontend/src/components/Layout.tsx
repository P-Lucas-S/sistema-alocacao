...
import { LogOut, LayoutDashboard, Users, UserCheck, FolderOpen, Clock, LayoutGrid, Moon, Sun, ArrowLeftRight, DollarSign, Tag, Briefcase } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/areas', label: 'Áreas', icon: Briefcase, gestorOrAdmin: true },
