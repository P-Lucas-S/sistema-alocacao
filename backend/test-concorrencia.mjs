...
async function runRodada(token, n) {
  ...
  const pA   = await post('/api/projetos', { codigo: `A${uid()}`, nome: 'Ataque A', prestacoesContas: ['2027-01-31'] }, token);
  ...
  const pB   = await post('/api/projetos', { codigo: `B${uid()}`, nome: 'Ataque B', prestacoesContas: ['2027-01-31'] }, token);
